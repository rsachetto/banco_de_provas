...
urlpatterns = patterns('',
    ...
    (r'^atualiza_valor_questao/', atualiza_valor_questao),
    (r'^atualiza_ordem_questao/', atualiza_ordem_questao),
    ...
    (r'^modifica_prova/(?P<prova_id>\d+)/(?P<questao_id>[-+]?\d+)/(?P<nova_questao_id>\d+)/$', modifica_prova),
